...
The `.claude/agents/` directory contains specialized review agents installed by [hulma](https://github.com/Dorky-Robot/hulma). They're usable in any project via Claude Code's Task tool:
