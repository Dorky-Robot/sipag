...
description: Backlog triage agent. Evaluates open issues against VISION.md and ARCHITECTURE.md, recommending CLOSE (conflicts with vision), ADJUST (needs labels/rewording), KEEP (aligns), or MERGE (duplicate). Use to clean up the issue backlog before dispatch cycles.
model: haiku
---
